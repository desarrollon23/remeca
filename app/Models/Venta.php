...
class Venta extends Model
{
    ...
    protected $fillable = ['id', 'fechaventa', 'horaventa', 'cedulav', 'idlugarv', 'idestatuspagov', 'idtipopagov', 'efectivo', 'transferencia', 'idtipoabonov', 'negociacion_id', 'placa', 'totalcomrav', 'totalpagadov', 'diferenciapagov', 'ajusteporpesov', 'observacionesv', 'despachado'];

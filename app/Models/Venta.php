...
class Venta extends Model
{
    ...
    protected $fillable = ['id', 'fechaventa', 'horaventa', 'cedulav', 'idlugarv', 'idestatuspagov', 'idtipopagov', 'negociacion_id', 'placa', 'totalcomrav', 'totalpagadov', 'diferenciapagov', 'ajusteporpesov', 'observacionesv', 'despachado'];

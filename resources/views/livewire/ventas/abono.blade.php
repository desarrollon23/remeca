...
"><div style="display: flex; flex-wrap: wrap; margin-right: 2px;"><h3 class="card-title" style="color: #fff; text-shadow: 2px 2px 2px black;">Fecha: {{ date('d-m-Y') }} | Negociación #: {{$recepcionmaterial_id}}</h3></div></div>
                <div class="card-body" style="display: flex; flex-wrap: wrap; margin-right: 2px;">
                  ...
                  <div style="width: 59%; margin-right: 2px;"><label for="nombre" style="width: 100%; margin-right: 2px;">Nombre
                    <input wire:model="nombre" wire:keyup="buspron" style="width: 100%; text-transform: uppercase;" id="nombre" class="form-control" type="text" name="nombre" value="{{ $cliente[0]->nombrec }}" placeholder="Ingrese el Nombre" disabled>
